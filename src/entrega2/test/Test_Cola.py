...
if __name__ == '__main__':
    ...
    cola:Cola = Cola()  # Crea una nueva cola
    elementos_a_agregar:list[int] = [23, 47, 1, 2, -3, 4, 5]
    ...
    elementos_eliminados:list[int] = cola.remove_all()  # Elimina todos los elementos de la cola
